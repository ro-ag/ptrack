...
| RD-1 | Unicode and emoji | Print combining, wide, emoji, flag, and box-drawing fixtures with Modern Unicode both enabled and disabled. | Combining, wide, emoji, and flag fixtures remain legible; enabled mode aligns the sample separators. | macOS, Windows, Linux |
