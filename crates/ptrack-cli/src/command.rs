...
pub const LEAVES: &[LeafSpec] = &[
    ...
    leaf(&["plan", "delete"], ArgCount::Exact(1)),
    leaf(&["plan", "move"], ArgCount::Exact(1)),
    leaf(&["plan", "copy"], ArgCount::Exact(1)),
    leaf(&["plan", "dep", "add"], ArgCount::Exact(2)),
    leaf(&["plan", "dep", "remove"], ArgCount::Exact(2)),
    leaf(&["plan", "dep", "list"], ArgCount::Exact(1)),
    ...
    leaf(&["task", "dep", "add"], ArgCount::Exact(2)),
    leaf(&["task", "dep", "remove"], ArgCount::Exact(2)),
    leaf(&["task", "dep", "list"], ArgCount::Exact(1)),
    ...
    leaf(&["issue", "edit"], ArgCount::Exact(1)),
    leaf(&["issue", "link"], ArgCount::Exact(1)),
    leaf(&["issue", "unlink"], ArgCount::Exact(1)),
    leaf(&["issue", "schedule"], ArgCount::Exact(1)),
    ...
    leaf(&["agent", "list"], ArgCount::None),
    leaf(&["agent", "show"], ArgCount::Exact(1)),
    leaf(&["agent", "inbox"], ArgCount::None),
