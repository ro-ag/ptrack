...
describe("Tauri compatibility bridge", () => {
  it("pins the exact current command allowlist", () => {
    expect(COMMANDS).toEqual([
      ...
      "GetCapabilityAuditsV2", "GetInitializationStatusV1", "GetPendingInitializationV1", "GetRecentProjects", "GetRecentProjectsV1", "GetTaskDetailV2",
      ...
      "RenameTask", "RenameTaskV2", "ResizeTerminal", "ResizeTerminalV2", "ResolveRecentProjectV1",
      "RollbackLinkedAgentLaunchV2", "SaveCapabilityV2", "SearchV2",
      "SendAgentHandoffV2", "SetAgentTaskOwnershipV2", "SetAgentWorktreeV2",
      "SetAutomaticUpdateChecks", "StartFirstTaskV1", "TestCapabilityV2", "ValidateProjectTargetV1", "ValidateTerminalCWDsV2",
