...
describe("Tauri compatibility bridge", () => {
  it("pins the exact current command allowlist", () => {
    expect(COMMANDS).toEqual([
      ...
      "GetCapabilityAuditsV2", "GetDiagnosticsReport", "GetInitializationStatusV1", "GetPendingInitializationV1",
      ...
      "RenameTask", "RenameTaskV2", "ResetPreferences", "ResizeTerminal", "ResizeTerminalV2", "ResolveRecentProjectV1",
      "RollbackLinkedAgentLaunchV2", "SaveCapabilityV2", "SearchV2",
      "SendAgentHandoffV2", "SetAgentTaskOwnershipV2", "SetAgentWorktreeV2",
      "SetAutomaticUpdateChecks", "SetPreferences", "StartFirstTaskV1", "TestCapabilityV2", "ValidateProjectTargetV1",
